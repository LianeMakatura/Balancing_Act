...
public partial class Importer : MonoBehaviour {

	public char Separator = '/';
	public string Directory = "SVGScripts"; //"RageTools/Demo/SvgFiles";
...
//		fileName = "mushroom.svg";
		button.onClick.AddListener(() => ImportSvg());
