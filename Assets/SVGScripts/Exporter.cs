...
// GL: code heavily borrowed from OBJExporter, credited below
/*=============================================================================
...
public class Exporter : ScriptableWizard
{
...
//		button.onClick.AddListener (() => CreateWizard ());
	}
	...
	void OnWizardUpdate()
	{
		helpString = "OBJ Exporter " + versionString;
	}
