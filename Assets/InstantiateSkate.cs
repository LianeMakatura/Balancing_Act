...
public class InstantiateSkate : MonoBehaviour {
	...
	void Start () {
		...
		myselfButton.onClick.AddListener(() => instantiateMySkate());
	}

	void instantiateMySkate() {
...
//		pend.AddComponent<MeshCollider> ();
	...
	void Destroy() {
		myselfButton.onClick.RemoveListener(() => instantiateMySkate());
	}
}