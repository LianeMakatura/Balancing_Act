...
public class RageSpline : MonoBehaviour, IRageSpline {
	...
	static public bool showSplineGizmos = true;
	static public bool showOtherGizmos = true;
	...
	static public Vector3 OutlineOffset = new Vector3(0, 0, -0.002f);
	...
	public void AssignCachedMaterials() {
		if (PerspectiveMode) {
			...
			mats3D[1] = Resources.Load("RS3DAA") as Material;	//TODO: Add a cached Textured AA Material
	...
	public MeshFilter GenerateMesh(bool refreshTriangulation, bool useOwners) {
		...
		GenerateTrianglesSetup(Mfilter, refreshTriangulation, verts, fillVerts, embossVerts, outlineVerts, fillAntialiasing, embossAntialiasing, outlineAntialiasing, multipleMaterials, uvs, uvs2, colors);
													...
													Vector3 normalizedNormal, RageVertex[] outlineVerts, int v, Vector3 normal, RageVertex[] splits, float AAWidth) 
	{
		...
		if (antialiasing) {
			...
			Vector3 outlineAaOffset = PerspectiveMode ? OutlineAaOffset : Vector3.zero;
...
// 			Debug.Log("splits.length:" + splits.Length + ", vertCount:" + vertCount);
	...
	public Vector3 ScaleToLocal(Vector3 vec) {
		return LocalAaWidth ? new Vector3(vec.x * (1f / transform.lossyScale.x), vec.y * (1f / transform.lossyScale.y), vec.z * (1f / transform.lossyScale.z)) 
							: vec;
	}
...
// 				vCount = pCount + pCountFix;
	...
	public void CopyStyling (RageSpline refSpline) {
        antiAliasingWidth = refSpline.antiAliasingWidth;
        emboss = refSpline.emboss;
        embossAngle = refSpline.embossAngle;
        embossColor1 = refSpline.embossColor1;
        embossColor2 = refSpline.embossColor2;
        embossCurveSmoothness = refSpline.embossCurveSmoothness;
        embossOffset = refSpline.embossOffset;
        embossSize = refSpline.embossSize;
        fill = refSpline.fill;
        fillColor1 = refSpline.fillColor1;
        fillColor2 = refSpline.fillColor2;
        gradientAngle = refSpline.gradientAngle;
        gradientOffset = refSpline.gradientOffset;
        gradientScale = refSpline.gradientScale;
        outline = refSpline.outline;
        outlineColor1 = refSpline.outlineColor1;
        outlineColor2 = refSpline.outlineColor2;
        outlineTexturingScale = refSpline.outlineTexturingScale;
        OutlineWidth = refSpline.OutlineWidth;
        outlineGradient = refSpline.outlineGradient;
        outlineNormalOffset = refSpline.outlineNormalOffset;
        corners = refSpline.corners;
        textureAngle = refSpline.textureAngle;
        textureAngle2 = refSpline.textureAngle2;
        textureOffset = refSpline.textureOffset;
        textureOffset2 = refSpline.textureOffset2;
        textureScale = refSpline.textureScale;
        textureScale2 = refSpline.textureScale2;
        UVMapping1 = refSpline.UVMapping1;
        UVMapping2 = refSpline.UVMapping2;
